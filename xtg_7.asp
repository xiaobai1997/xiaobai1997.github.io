...
if name = "" then
%>
<img src="http://ymstrading.com/zb/fc/toutu.php?id=2&name=%E5%B0%8F%E9%9F%AC%E5%93%A5">

 <%
else
%>
<img src="http://ymstrading.com/zb/fc/toutu.php?id=<%response.write ok%>&name=<%response.write name%>">
<%
end if
%></span>         
  </div>
