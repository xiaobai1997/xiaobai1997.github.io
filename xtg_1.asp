...
if name = "" then
%>
<img src="http://odkah.com/zb/ns/toutu.php?id=1&name=小韬哥">


 <%
else
%>
<img src="http://odkah.com/zb/ns/toutu.php?id=<%response.write ok%>&name=<%response.write name%>">
...
%></span>         
    ...
    <form id="form" name="form" method="post">
     ...
     <div class="form-group col-xs-12 col-sm-3 col-md-3">
          <div class="input-group">
            <div class="input-group-addon">男神</div>
