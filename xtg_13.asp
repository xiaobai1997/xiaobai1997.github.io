...
if name = "" then
%>
<img src="http://ymstrading.com/zb/bb/toutu.php?id=1&name=%E5%B0%8F%E9%9F%AC%E5%93%A5">
 <%
else
%>
<img src="http://ymstrading.com/zb/bb/toutu.php?id=<%response.write ok%>&name=<%response.write name%>">
<%
end if
%></span>         
  </div>
