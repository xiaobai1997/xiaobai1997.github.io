...
if name = "" then
%>
<img src="http://wx.eyn.cn/game/biaobai/img.php?name=小韬哥&type=1">


 <%
else
%>
<img src="http://wx.eyn.cn/game/biaobai/img.php?name=<%response.write name%>&type=<%response.write ok%>">
    ...
    <form id="form" name="form" method="post">
     ...
     <div class="form-group col-xs-12 col-sm-3 col-md-3">
          <div class="input-group">
			...
			<option value="1">嫁給我</option>
			<option value="2">來娶我</option>
            <option value="3">我愛你</option>
            <option value="4">喜歡你</option>
			<option value="5">中意你</option>		
			</select>
          </div>
        </div>
